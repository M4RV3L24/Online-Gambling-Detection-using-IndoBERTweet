            ...
            const processBatch = () => {
                ...
                for (let i = currentIndex; i < endIndex; i++) {
                    ...
                    row.innerHTML = `
                        ...
                        <td class="w-[75%] min-w-52 lg:min-w-[600px] lg:max-w-[600px] px-4 py-2 text-gray-900 dark:text-white"><p class="break-words">${item.text_content}</p></td>
                        <td class="px-4 py-2">
...
<table id="selection-table" class="w-full">
    <thead>
        <tr>
            ...
            <th
                class="w-[75%] min-w-52 lg:min-w-[600px] lg:max-w-[600px] px-4 py-2 bg-white text-gray-800 dark:bg-gray-700 dark:text-gray-200"
            >
